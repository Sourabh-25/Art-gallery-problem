#GroupID-26 (21114036_21114053)
#Date October 10, 2024
#main.py Main File does all the operations
...
def createMonoPolygon(d,p):
    ...
    os.system('rm makemonotone.cpp')
    os.system("./a.out > artgalleryout")

    # call(["./a.out","> artgalleryout"])
    with open('artgalleryout','r') as f:
        content = f.readlines()
...
plt.legend()
nowDraw(toDraw)
os.system('rm artgalleryinput artgalleryout a.out')
